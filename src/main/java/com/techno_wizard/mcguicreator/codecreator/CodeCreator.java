...
public class CodeCreator {
    ...
    public static List<String> writecode(MainMenu mainMenu) {
        ...
        InventoryTableModel model = mainMenu.getInvManager().getInventoryTableModel();
        ...
        String inventoryName = mainMenu.getInvManager().getInventoryTableModel().getInventoryName();
