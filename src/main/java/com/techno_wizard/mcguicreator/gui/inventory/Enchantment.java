...
public class Enchantment implements Serializable {
    ...
    public enum EnchantmentType {
        ...
        //Armour
        PROTECTION(10), PROTECTION_FIRE(10), PROTECTION_FALL(10), PROTECTION_EXPLOSIONS(10), PROTECTION_PROJECTILE(10), RESPIRATION(10), AQUA_AFINITY(10), THORNS(10), DEPTH_STRIDER(10), FROSTWALKER(10),
        //Weapons
